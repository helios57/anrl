...
namespace AnrlDB
{
    ...
    partial void Deletet_User_Session(t_User_Session instance);
		...
		public System.Data.Linq.Table<t_Competition_Team> t_Competition_Teams
		{
			get
			{
    ...
    partial void OnTimeTakeOffChanging(long value);
    partial void OnTimeTakeOffChanged();
    partial void OnTimeStartChanging(long value);
    ...
    partial void OnID_CompetitionSetChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Route", DbType="Int NOT NULL")]
		public int Route
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_TimeStart", DbType="BigInt NOT NULL")]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_TimeEnd", DbType="BigInt NOT NULL")]
		public long TimeEnd
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="t_Competition_Team_t_Team_Tracker", Storage="_t_Team_Trackers", ThisKey="ID", OtherKey="ID_Competition_Team")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="t_Team_t_Competition_Team", Storage="_t_Team", ThisKey="ID_Team", OtherKey="ID", IsForeignKey=true)]
    ...
    partial void OnID_CompetitionSetChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ID_Competition_Team", DbType="Int NOT NULL")]
		public int ID_Competition_Team
		{
			get
			{
				return this._ID_Competition_Team;
			}
			set
			{
				if ((this._ID_Competition_Team != value))
				{
					if (this._t_Competition_Team.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.OnID_Competition_TeamChanging(value);
					this.SendPropertyChanging();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="t_Competition_Team_t_Penalty", Storage="_t_Competition_Team", ThisKey="ID_Competition_Team", OtherKey="ID", IsForeignKey=true)]
		public t_Competition_Team t_Competition_Team
		{
			get
			{
				return this._t_Competition_Team.Entity;
			}
			set
			{
				t_Competition_Team previousValue = this._t_Competition_Team.Entity;
				if (((previousValue != value) 
							|| (this._t_Competition_Team.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._t_Competition_Team.Entity = null;
						previousValue.t_Penalties.Remove(this);
					}
					this._t_Competition_Team.Entity = value;
					if ((value != null))
					{
						value.t_Penalties.Add(this);
						this._ID_Competition_Team = value.ID;
					}
					else
					{
						this._ID_Competition_Team = default(int);
					}
					this.SendPropertyChanged("t_Competition_Team");
				}
			}
		}
    ...
    partial void OnID_CompetitionSetChanging(int value);
    partial void OnID_CompetitionSetChanged();
    partial void OnStartIDChanging(string value);
    partial void OnStartIDChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_StartID", DbType="VarChar(50)")]
    ...
    partial void OnID_TrackerChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ID_Competition_Team", DbType="Int NOT NULL", IsPrimaryKey=true)]
		public int ID_Competition_Team
		{
			get
			{
