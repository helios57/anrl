...
namespace DataService
{
    ...
    partial void OnID_PolygonChanged();
		...
		[Association(Name="t_Flugzeug_t_Daten", Storage="_t_Flugzeug", ThisKey="ID_Flugzeug", IsForeignKey=true)]
    ...
    partial void OnIMEIChanged();
		...
		[Association(Name="t_Tracker_t_Flugzeug", Storage="_t_Flugzeugs", OtherKey="ID_GPS_Tracker")]
    ...
    partial void OnID_GPS_TrackerChanged();
		...
		[Association(Name="t_Flugzeug_t_Daten", Storage="_t_Datens", OtherKey="ID_Flugzeug")]
		...
		[Association(Name="t_Tracker_t_Flugzeug", Storage="_t_Tracker", ThisKey="ID_GPS_Tracker", IsForeignKey=true)]
