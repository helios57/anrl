...
namespace UTMtoWGS
{
    ...
    {
        private static double pi = Math.PI;//3.14159265358979;
        ...
        *
        */
        private static void UTMXYToLatLon(double x, double y, double zone, bool southhemi, double[] latlon)
        {
            double cmeridian;
        ...
        public static double[] getLatLon(int zone, double x, double y, bool southhemi)
        {
